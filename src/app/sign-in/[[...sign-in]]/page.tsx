    ...
    <div style={{ paddingTop: 'var(--nav-height, 60px)' }} className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm py-10">
        <div className="text-center mb-7">
          ...
          <p className="text-[12px] text-neutral-400 mt-1.5">Sign in to your account to continue.</p>
        </div>
        <SignIn
          routing="path"
          path="/sign-in"
          ...
          appearance={{
            elements: {
              ...
              dividerText: 'text-[11px] tracking-widest uppercase text-neutral-400 bg-white',
              formFieldLabel: 'text-[11px] tracking-widest uppercase text-neutral-500',
